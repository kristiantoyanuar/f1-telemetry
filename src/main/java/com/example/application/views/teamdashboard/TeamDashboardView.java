package com.example.application.views.teamdashboard;


import com.example.application.views.MainLayout;
import com.example.application.views.teamdashboard.ServiceHealth.Status;
...
@Route(value = "team-dashboard", layout = MainLayout.class)
@RolesAllowed("USER")
public class TeamDashboardView extends Main {

    public TeamDashboardView() {
        addClassName("team-dashboard-view");
